package com.conversionappandroid.webservice;
...
public class WeatherService extends IntentService {
    ...
    private static final String BASE_URL = "https://api.darksky.net/forecast/a0b926f5e2b2a2206f84c67addbc7e40/";
    ...
    private void fetchWeatherData(String key, String lat, String lon, String time) {
        try {
            // Format the url based on the input params
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                // extract the values you need out of current
                ...
                // use putExtra to add the extracted values to your broadcast
